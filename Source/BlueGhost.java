...
public class BlueGhost extends Ghost
{
    ...
    public BlueGhost(int xLoc, int yLoc, char dir)
    {
        super(xLoc, yLoc, dir, xLoc, yLoc, dir, 4);
        try {
            image3u = ImageIO.read(new File("Images/Ghosts/Blue Ghost/blueGhost3up.png"));
            image3d = ImageIO.read(new File("Images/Ghosts/Blue Ghost/blueGhost3down.png"));
            image3l = ImageIO.read(new File("Images/Ghosts/Blue Ghost/blueGhost3left.png"));
            image3r = ImageIO.read(new File("Images/Ghosts/Blue Ghost/blueGhost3right.png"));
            image4u = ImageIO.read(new File("Images/Ghosts/Blue Ghost/blueGhost4up.png"));
            image4d = ImageIO.read(new File("Images/Ghosts/Blue Ghost/blueGhost4down.png"));
            image4l = ImageIO.read(new File("Images/Ghosts/Blue Ghost/blueGhost4left.png"));
            image4r = ImageIO.read(new File("Images/Ghosts/Blue Ghost/blueGhost4right.png"));
    ...
    public int getTargetX(int pacmanX, int pacmanY, char pacmanDirection, int redGhostX, int redGhostY, int x,int y)
    {
        ...
        {
            int middleX = getSpecificMiddleX(pacmanX, pacmanY, pacmanDirection);
            return (2*middleX - redGhostX);
        }
        else
        {
    ...
    public int getTargetY(int pacmanX, int pacmanY, char pacmanDirection, int redGhostX, int redGhostY, int x,int y)
    {
        ...
        {
            int middleY = getSpecificMiddleY(pacmanX, pacmanY, pacmanDirection);
            return (2*middleY - redGhostY);
        }
        else
        {
            if(x == 240 && y == 300)
    ...
    public int getSpecificMiddleX(int pacmanX, int pacmanY, char pacmanDirection)
                        // these 2 methods are same as PinkGhost's getTarget methods
    {
    ...
    public int getSpecificMiddleY(int pacmanX, int pacmanY, char pacmanDirection)
    {
